...
private:
  ...
  void serialize( Archive& ar, const unsigned int version )
  {
     ...
     *       the result is correct, but the id_generator will waste an id */
    ar & sequence_id;
 ...
 * to represent such part; each chunk contains an independent task to do (sources
...
public:
   ...
   *   Note: the function has to be a thread-safe one (several threads may execute it concurrently)
   *
...
private:
  ...
  /* to split a serialization into 'save' and 'load' function */
  BOOST_SERIALIZATION_SPLIT_MEMBER();
